...
* skriv: foamListTimes -rm
* skriv: rm -r postProcessing

2 : Finn navn på mesh som skal brukes,
sørg for at du er her .../GCI-3grid_simuleringer - gå til :
* skriv: cd icoFoam-fine/caseDict
...
* skriv: cp caseDict/blockMeshDict_fine system/blockMeshDict

4 : Lag mesh og simmuler
* skriv: blockMesh (Hvis du vil være sikker på om du har riktig mesh aktivert kan du sjekke ncells (tabell over for hva some er riktig))
* skriv: icoFoam
